...
public class SmppClient {
	static Logger logger = LoggerFactory.getLogger(SmppClient.class);

	public static void main(String[] args) {
		SmppClient.sendSmppSms("RockyMobi", "10.12.51.27", 5016, "RockyMobi", "r0ckY$tL", "9774265", "19817139141", "hello,this is rockmobi.");
	}
	...
	public static void sendSmppSms(String name, String host, int port, String systemId, String password, String fromCode, String toCode, String content) {
		...
		logger.info("smpp connect to {}:{}", host, port);
