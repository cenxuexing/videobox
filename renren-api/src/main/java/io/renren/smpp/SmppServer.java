...
public class SmppServer {
	...
	public static class DefaultSmppServerHandler implements SmppServerHandler {
		...
		public void sessionBindRequested(Long sessionId, SmppSessionConfiguration sessionConfiguration, final BaseBind bindRequest) throws SmppProcessingException {
			...
			logger.info("sessionBindRequested sessionConfiguration : " + ReflectionToStringBuilder.toString(sessionConfiguration));
			logger.info("sessionBindRequested bindRequest : " + ReflectionToStringBuilder.toString(sessionConfiguration));
		}
