...
public class CellcardAuthCallBackReq extends BaseCommandParam implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5961686487529943361L;
	...
	public enum authorisationStateEnum {
		AUTH_NEW("new"),//
		AUTH_PENDING("pending"),//
		AUTH_CONFIRMED("confirmed"),//
		AUTH_VERIFIED("verified"),//
		AUTH_FAILED("failed"),//
		AUTH_INVALIDATED("invalidated"),//
		
		;
		
		private final String state;
		
		authorisationStateEnum(String state) {
			this.state = state;
		}
