 ...
 */
@Service
public class SunPayServiceImpl implements SunPayService {

    private static final Logger LOGGER = LoggerFactory.getLogger(SunPayServiceImpl.class);
    ...
    public String inboundSmsSub(String phoneNo) {
        ...
        map.put("notifyURL", "http://168.63.246.122:80/renren-api/sun/sync/order/relation");
