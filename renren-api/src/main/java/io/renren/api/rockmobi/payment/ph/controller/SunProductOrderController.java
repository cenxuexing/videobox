...
@RestController
@RequestMapping("/sun")
public class SunProductOrderController {
    private static final Logger LOGGER = LoggerFactory.getLogger(SunProductOrderController.class);

    @Value("${ph.sun.sp_password}")
    ...
    public R firstCertification(@RequestBody MerchantProductOperAtorBO merchantProductOperAtorBo, HttpServletRequest req) {
        ...
        try {
            ...
            if (ErrorCodeTemp.CODE_9001.equals(r.get("code"))) {
                ...
                if (rLock.isLocked()) {
                    //发起订阅请求
                    PhResultResponse phResultResponse = sunPayService.subscribeProductRequest(merchantProductOperAtorBo);
    ...
    public R inbound(String phoneNo) {
        String str = sunPayService.inboundSmsSub(phoneNo);
            ...
            if (ErrorCodeTemp.CODE_9001.equals(r.get("code"))) {
                ...
                if (rLock.isLocked()) {
                    ...
                    try {
                        ...
                        String str = sunPayService.inboundSmsSub(userMsisdn);
    ...
    public R individualInboundSmsCertification(String phoneNp, HttpServletRequest req) {
        ...
        //phPayService.
        String str = sunPayService.individualInboundSmsCertification("http://125.60.148.174:8312/1/smsmessaging/inbound/subscriptions/10001906140419500001227700", phoneNp);
        return R.ok().put("data", str);
    }
